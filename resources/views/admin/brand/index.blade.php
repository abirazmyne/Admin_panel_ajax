...
@section('body')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Manage Shop Brand</h1>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <div class="btn-list">
                <a href="task-create.html" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#addBrandModal">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Add Brand Table</h3>
                </div>
                <div class="card-body">
    ...
    <div class="modal fade" id="addBrandModal" tabindex="-1" aria-labelledby="addBrandModal" aria-hidden="true">
        <form action="{{route('brand.create')}}" method="POST" enctype="multipart/form-data"  id="addBrandForm">
            @csrf
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleBrandLabel">Add a Brand</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group my-3">
                            <label for="price">Brand Image</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="saveBTNbrand">Save Brand</button>
                    </div>
                </div>
            </div>
        </form>
...
@section('script')
    <script>
        $(document).ready(function () {
            $(document).on('click','#saveBTNbrand', function (e) {
                e.preventDefault();
                let name = $('#name').val();
            ...
            $(document).on('click', '.update_product_form', function () {
                ...
                $('#current_image').attr("src", "{{ asset('admin/images/brand') }}/" + image);
