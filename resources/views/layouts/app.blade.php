            ...
            <div class="container-fluid main-container">
                <div class="d-flex">
                    ...
                    <a class="logo-horizontal " href="{{route('dashboard')}}">
                        <img src="{{asset('/')}}admin/assets/images/logo.png" class="header-brand-img desktop-logo" alt="logo">
                        <img src="{{asset('/')}}admin/assets/images/logo.png" class="header-brand-img light-logo1"
                             alt="logo">
                    </a>
                    <!-- LOGO -->
            ...
            <div class="app-sidebar">
                <div class="side-header">
                    <a class="header-brand1" href="{{route('dashboard')}}">
                        <img src="{{asset('/')}}admin/assets/images/logo.png" class="header-brand-img desktop-logo" alt="logo">
                        <img src="{{asset('/')}}admin/assets/images/logo.png" class="header-brand-img toggle-logo" alt="logo">
                        <img src="{{asset('/')}}admin/assets/images/logo.png" class="header-brand-img light-logo" alt="logo">
                        <img src="{{asset('/')}}admin/assets/images/logo.png" class="header-brand-img light-logo1" alt="logo">
                    </a><!-- LOGO -->
                </div>
...
{{--                            <ul class="slide-menu">--}}
{{--                                <li><a href="('subCategory.add')}}" class="slide-item">Add Sub-Category</a></li>--}}
{{--                                <li><a href="('subCategory.manage')}}" class="slide-item">Manage Sub-Category</a></li>--}}

{{--                            </ul>--}}
{{--                        </li>--}}
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="{{route('brand.index')}}">
                                ...
                                <span class="side-menu__label">Brand Module</span>
                                <i class="angle fa fa-angle-right"></i>
                            </a>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="{{route('unit.index')}}">
                                ...
                                <span class="side-menu__label">Unit Module</span>
                                <i class="angle fa fa-angle-right"></i></a>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="{{route('product.index')}}">
                                <svg xmlns="" class="side-menu__icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M12.1124268,2.0010986C7.6941528,1.9389648,4.0620728,5.4703979,4,9.8886719c0,5.4482422,7.3642578,11.7285156,7.6777344,11.9931641C11.7677002,21.958313,11.881958,22.0001831,12,22c0.118042,0.0001831,0.2322998-0.041687,0.3222656-0.1181641C12.6357422,21.6171875,20,15.3369141,20,9.8886719C19.9391479,5.5579224,16.4431763,2.0619507,12.1124268,2.0010986z M12,20.8339844C10.5839844,19.5625,5,14.2666016,5,9.8886719C5.0353394,6.0553589,8.166626,2.973877,12,3c3.833374-0.026123,6.9647217,3.0553589,7,6.8886719C19,14.2626953,13.414978,19.5615234,12,20.8339844z M12,7c-1.6568604,0-3,1.3431396-3,3s1.3431396,3,3,3c1.6561279-0.0018311,2.9981689-1.3438721,3-3C15,8.3431396,13.6568604,7,12,7z M12,12c-1.1045532,0-2-0.8954468-2-2s0.8954468-2,2-2c1.1040039,0.0014038,1.9985962,0.8959961,2,2C14,11.1045532,13.1045532,12,12,12z"/></svg>
                                <span class="side-menu__label">Product Module</span>
                                <i class="angle fa fa-angle-right"></i>
                            </a>
                        </li>

                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="{{route('supplier.index')}}">
                                ...
                                <span class="side-menu__label">Supplier Module</span>
                                <i class="angle fa fa-angle-right"></i>
                            </a>
                        </li>
...
{{--                            <a class="side-menu__item" data-bs-toggle="slide" href="#">--}}
{{--                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M21.5,13h-8.0005493C13.2234497,13.0001831,12.9998169,13.223999,13,13.5v8.0005493C13.0001831,21.7765503,13.223999,22.0001831,13.5,22h8.0006104C21.7765503,21.9998169,22.0001831,21.776001,22,21.5v-8.0006104C21.9998169,13.2234497,21.776001,12.9998169,21.5,13z M21,21h-7v-7h7V21z M10.5,2H2.4993896C2.2234497,2.0001831,1.9998169,2.223999,2,2.5v8.0005493C2.0001831,10.7765503,2.223999,11.0001831,2.5,11h8.0006104C10.7765503,10.9998169,11.0001831,10.776001,11,10.5V2.4993896C10.9998169,2.2234497,10.776001,1.9998169,10.5,2z M10,10H3V3h7V10z M10.5,13H2.4993896C2.2234497,13.0001831,1.9998169,13.223999,2,13.5v8.0005493C2.0001831,21.7765503,2.223999,22.0001831,2.5,22h8.0006104C10.7765503,21.9998169,11.0001831,21.776001,11,21.5v-8.0006104C10.9998169,13.2234497,10.776001,12.9998169,10.5,13z M10,21H3v-7h7V21z M21.5,2h-8.0005493C13.2234497,2.0001831,12.9998169,2.223999,13,2.5v8.0005493C13.0001831,10.7765503,13.223999,11.0001831,13.5,11h8.0006104C21.7765503,10.9998169,22.0001831,10.776001,22,10.5V2.4993896C21.9998169,2.2234497,21.776001,1.9998169,21.5,2z M21,10h-7V3h7V10z"/></svg>--}}
{{--                                <span class="side-menu__label">Courier Module</span>--}}
{{--                                <i class="angle fa fa-angle-right"></i>--}}
{{--                            </a>--}}
{{--                            <ul class="slide-menu">--}}
{{--                                <li><a href="('courier.add')}}" class="slide-item">Add Courier</a></li>--}}
{{--                                <li><a href="('courier.manage')}}" class="slide-item">Manage Courier</a></li>--}}
{{--                            </ul>--}}
{{--                        </li>--}}
...
{{--                                <span class="side-menu__label">Order Module</span>--}}
{{--                                <i class="angle fa fa-angle-right"></i>--}}
{{--                            </a>--}}
{{--                            <ul class="slide-menu">--}}

{{--                                <li><a href="('admin-order.all')}}" class="slide-item">Orders</a></li>--}}
{{--                                <li><a href="typography.html" class="slide-item">Manage Orders</a></li>--}}
{{--                            </ul>--}}
{{--                        </li>--}}
{{--                        <li class="slide">--}}
{{--                            <a class="side-menu__item" data-bs-toggle="slide" href="#">--}}
...
{{--                                <span class="side-menu__label">Customer Module</span><i class="angle fa fa-angle-right"></i></a>--}}
{{--                            <ul class="slide-menu">--}}

{{--                                <li><a href="opacity.html" class="slide-item">Manage Customer</a></li>--}}
...
{{--                                <span class="side-menu__label">Admin User Module</span><i class="angle fa fa-angle-right"></i>--}}
{{--                            </a>--}}
{{--                            <ul class="slide-menu">--}}
{{--                                <li><a href="users-list.html" class="slide-item">Users</a></li>--}}
{{--                                <li><a href="file-attachments.html" class="slide-item">Manage Users</a></li>--}}
{{--                            </ul>--}}
{{--                        </li>--}}
{{--                        <li>--}}
{{--                            <h3>Pages</h3>--}}
...
{{--                                <span class="side-menu__label"> Blog Module</span>--}}
{{--                                <i class="angle fa fa-angle-right"></i>--}}
{{--                            </a>--}}
{{--                            <ul class="slide-menu">--}}

{{--                                <li><a href="services.html" class="slide-item">Add Blog</a></li>--}}
{{--                                <li><a href="switcher.html" class="slide-item">Manage Blogs</a></li>--}}
{{--                            </ul>--}}
{{--                        </li>--}}
        ...
        <div class="container">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-12 col-sm-12 text-center">
                    Copyright © 2024 <a href="#">Boneek</a>. Collaboration with <span class="fa fa-heart text-danger"></span> by <a href="#"> Abir Azmyne </a> All rights reserved
                </div>
            </div>
        </div>
    </footer>
